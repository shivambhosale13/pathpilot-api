...
function buildRecommendationsFallbackCandidates() {
  const allRecommendations = [
    ...
    {"career": "UX/UI Designer", "explanation": "Your creative thinking and user-focused approach make you ideal for design roles."},
    {"career": "Product Manager", "explanation": "Your strategic thinking and leadership skills are perfect for product management."},
    {"career": "Marketing Manager", "explanation": "Your communication skills and analytical thinking make you well-suited for marketing."},
    {"career": "Business Analyst", "explanation": "Your analytical skills and business understanding are ideal for business analysis."},
    {"career": "DevOps Engineer", "explanation": "Your technical skills and systematic approach make you perfect for DevOps roles."},
    {"career": "Cybersecurity Analyst", "explanation": "Your attention to detail and problem-solving skills are ideal for cybersecurity."},
    {"career": "AI/Machine Learning Engineer", "explanation": "Your analytical thinking and technical skills make you perfect for AI/ML roles."},
    {"career": "Cloud Architect", "explanation": "Your technical expertise and strategic thinking are ideal for cloud architecture."},
    {"career": "Digital Marketing Specialist", "explanation": "Your analytical skills and creativity make you well-suited for digital marketing."},
    {"career": "Financial Analyst", "explanation": "Your analytical thinking and attention to detail are perfect for financial analysis."},
    {"career": "Operations Manager", "explanation": "Your organizational skills and leadership abilities make you ideal for operations management."},
    {"career": "Sales Manager", "explanation": "Your communication skills and relationship-building abilities are perfect for sales management."},
    {"career": "Human Resources Manager", "explanation": "Your interpersonal skills and organizational abilities make you ideal for HR management."},
    {"career": "Content Manager", "explanation": "Your communication skills and creative thinking make you well-suited for content management."},
    {"career": "Quality Assurance Engineer", "explanation": "Your attention to detail and systematic approach are perfect for QA roles."},
    {"career": "Technical Writer", "explanation": "Your communication skills and technical understanding make you ideal for technical writing."},
    {"career": "Research Analyst", "explanation": "Your analytical thinking and research skills are perfect for research roles."},
    {"career": "Consultant", "explanation": "Your problem-solving skills and communication abilities make you ideal for consulting."},
    {"career": "Entrepreneur", "explanation": "Your leadership skills and innovative thinking make you perfect for entrepreneurship."},
    {"career": "Training and Development Specialist", "explanation": "Your communication skills and teaching abilities make you ideal for training roles."},
    {"career": "Event Manager", "explanation": "Your organizational skills and attention to detail are perfect for event management."},
    {"career": "Supply Chain Manager", "explanation": "Your analytical skills and organizational abilities make you ideal for supply chain management."},
    {"career": "Healthcare Administrator", "explanation": "Your organizational skills and attention to detail are perfect for healthcare administration."},
    {"career": "Environmental Consultant", "explanation": "Your analytical thinking and problem-solving skills make you ideal for environmental consulting."},
    {"career": "Real Estate Agent", "explanation": "Your communication skills and relationship-building abilities are perfect for real estate."},
    {"career": "Graphic Designer", "explanation": "Your creative thinking and visual skills make you ideal for graphic design."},
    {"career": "Social Media Manager", "explanation": "Your communication skills and creativity make you well-suited for social media management."}
  ];

  // Randomly select 3-5 recommendations
  const shuffled = allRecommendations.sort(() => 0.5 - Math.random());
  const selected = shuffled.slice(0, Math.floor(Math.random() * 3) + 3); // 3-5 recommendations
...
Analyze the user's personality traits, working style, interests, and skills from their quiz responses. Recommend ${limit} diverse, realistic careers that match their profile. Consider various industries including Technology, Business, Healthcare, Education, Arts, Finance, Marketing, and more.

For each career, provide a detailed explanation of why it matches their profile based on their specific quiz answers.

Return ONLY this JSON format:
{
  "recommendations": [
    {"career": "Career Name", "explanation": "Detailed explanation of why this career matches their quiz responses and personality traits"},
    {"career": "Career Name", "explanation": "Detailed explanation of why this career matches their quiz responses and personality traits"},
    {"career": "Career Name", "explanation": "Detailed explanation of why this career matches their quiz responses and personality traits"}
  ]
}`;
